...
- Location: /home/runner/work/playwright-ctrf-demo/playwright-ctrf-demo/test/example.spec.ts:24:7
...
Call log:
  ...
  - waiting for getByRole('link', { name: /docs/i }).first()
    ...
    at /home/runner/work/playwright-ctrf-demo/playwright-ctrf-demo/test/example.spec.ts:32:28
```
